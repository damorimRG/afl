...
names <- c('cmin','multi obj','no min', 'unwei sc', 'wei time')
...
list4 = read.csv("file-unweighted.data", header=FALSE, sep=",")
list5 = read.csv("file-weighted-size.data", header=FALSE, sep=",")
