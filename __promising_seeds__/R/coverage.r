...
# load the data
list1 = read.csv("cov-nomin.data", header=FALSE, sep=" ")
list2 = read.csv("cov-libfuzzer.data", header=FALSE, sep=" ")
list3 = read.csv("cov-mosa.data", header=FALSE, sep=" ")
list4 = read.csv("cov-uwsc.data", header=FALSE, sep=" ")
list5 = read.csv("cov-wsc-size.data", header=FALSE, sep=" ")
